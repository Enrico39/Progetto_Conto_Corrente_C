...
void main()
{
    int i=0;//la variabile i terrà conto del numero di ID creati
    int n=0;//questa variabile permetteà di uscire dal ciclo while
    int selezione_menu;//questa variabile indica la scelta presa nel menù del programma
    printf("\n========================================================\n");//stampa un benvenuto all'utente
    printf("   BENVENUTO NEL PROGRAMMA DI GESTIONE CONTO CORRENTE   ");
    printf("\n========================================================\n");
    while(n==0)//fin quando l'utente non deciderà di uscire il menù apparirà automaticamente alla fine di ogni operazione
    {
        printf("\n      - MENU' PRINCIPALE - \n\n1 - Inserire nuovo correntista;\n2 - Effettua un movimento\n3 - Visualizza lista dei movimenti;\n0 - Termina il programma.\nScelta: ");//Stampo il menù del programma
        ...
        case 3:     //inserendo 3 abbiamo accesso alla lista dei movimenti effettuati
            lista_movimenti(i);
            break;
        case 0:     //inserendo 0 usciamo dal menuù e possiamo terminare il programma
            n++;    //incrementando la variabile n possiamo uscire dal while
            printf("\n       - CONTO CORRENTE -\n\n");
            printf("Grazie per aver utilizzato il programma!\n");
            break;
        default:    //inserendo un elemento non riconosciuto apparirà una scritta che ci chiede di riprovare
